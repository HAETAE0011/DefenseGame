...
public class Tower : MonoBehaviour
{
    ...
    void UpdateEnemy()
    {
        ...
        {
            if (Vector3.Distance(transform.position, enemy.transform.position) <= rangeRadius)
            {
            ...
            if (towertoEnemynear <= rangeRadius)
            {
        ...
        if (shootEnemy != null )
        {
            ...
            //if (Vector3.Distance(transform.position, targetEnemy.transform.position) <= rangeRadius)
            //{
            //    Debug.Log("Enemy In range");
            //    targetEnemy.isInRange = true;
            //}
            //else
            //{
            //    Debug.Log("Enemy OUT range");
            //    targetEnemy.isInRange = false;
            //}
        }
        else
        {
